...
It is based on two parts. First we have implemented a EKF which uses the ardrone/odometry package to predict the velocity of the ardrone future in time. 
